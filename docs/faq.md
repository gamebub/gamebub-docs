...
??? question "How do I get a Game Bub?"
...
??? question "What shell colors are available?"
    ...
    You can 3D-print your own shell in any color, however, and some people on the Discord have also discussed the possibility of dyeing a colorless shell to another color.

??? question "How was Game Bub created?"
...
??? question "What's the difference between the vertical and horizontal Game Bub?"
...
??? question "Is Game Bub an emulator?"
...
??? question "What systems does Game Bub support?"
...
??? question "Is Game Bub 100% accurate?"

    No. Game Bub's Game Boy and Game Boy Advance cores have wide compatibility, but they're not 100% accurate (and have known issues in certain games).

    However, these are bugs, and we'd like to improve core compatibility and accuracy over time.

??? question "Does the Game Boy Advance core support Game Boy Player functionality?"

    Yes, the Game Boy Advance core has a setting to enable Game Boy Player emulation. This enables rumble in certain supported games. See the [GBA core settings](/user-guide/settings/#core-gba) for more details.

??? question "Do flashcarts work on the Game Bub?"
...
??? question "What are the specifications of Game Bub's screen?"
...
??? question "Does Game Bub support post-processing filters?"
...
??? question "What scaling modes does the display support?"
...
??? question "Are the buttons tactile (clicky) or membrane (soft)?"
...
??? question "What is the Game Bub Dock?"
...
??? question "What is the output resolution of the Dock?"
...
??? question "Does the Dock support analog video output?"

    No, the Dock only produces digital video output.

??? question "Can I use wireless controllers without the Dock?"

    No, wireless controllers may only be used when Game Bub is plugged into a Dock.

??? question "Can the link port be used while Game Bub is docked?"
...
??? question "Does the Dock support controller rumble?"

    As of Firmware 1.0, it does not. However, this is a feature we're interested in adding in the future for Game Boy / Game Boy Advance games that support rumble.

## Troubleshooting

??? question "My Game Bub isn't turning on."
...
??? question "Game Bub isn't recognizing my game cartridge."
...
??? question "I'm encountering an unexpected game bug."
