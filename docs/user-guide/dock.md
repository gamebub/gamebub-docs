...
<figure markdown="span"><figcaption>Front</figcaption> ![Dock front](images/diagram-dock-front.png){ width="480" }<figcaption>Rear</figcaption> ![Dock rear](images/diagram-dock-rear.png){ width="480" }</figure>
